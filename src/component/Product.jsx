...
const Product = () => {
  ...
  return (
    <section className="mb-37 w-full mt-25 mx-auto px-5" id="product">
      <div className="text-center">
        <button className="text-[#9C5B84] border cursor-pointer border-[#9C5B84] rounded-3xl bg-transparent py-1 px-3 font-normal flex items-center gap-2 mx-auto">
          <img
            src="src/assets/img/trend-icon.png"
            alt="Trend Icon"
            className="w-5 h-5 "
          />
          Trending
        </button>
        <h1 className="text-[#1E1D4C] mt-5 font-serif text-5xl font-semibold">
          Top Selling Products
        </h1>
        <p className="mt-5 text-[#9F9F9F]">
